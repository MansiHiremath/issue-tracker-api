...
public class BugControllerTest {
	...
	public void createBugTest() {
		String jsonReq = "{\"bugId\":\"\",\"title\":\"\",\"description\":\"Bug\",\"creationDate\":\"May 23,2022\",\"assignedDeveloper\":\"\",\"priority\":\"critical\",\"status\":\"New\"}";
		try {
	...
	public void deleteBugTest() {
		try {
			mockMvc.perform(
					MockMvcRequestBuilders.delete("/bugService/deleteBug/{id}", "0"))
